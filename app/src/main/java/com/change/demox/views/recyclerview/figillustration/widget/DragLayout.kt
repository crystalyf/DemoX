    ...
    fun reLayout(currentState: Int) {
        when (currentState) {
            ...
            State.AT_MIDDLE -> {
                ...
                maintenanceLayout!!.layoutParams.height = dragRange / 2
                netWorkErrorLayout!!.layoutParams.height = dragRange / 2
                recyclerView!!.layoutParams.height = (height - dragView!!.height) / 2
                progressLayout!!.layoutParams.height = dragRange / 2
            }
            State.AT_TOP -> {
                dragView!!.layout(
                    width - dragView!!.width,
                ...
                maintenanceLayout!!.layoutParams.height = dragRange
                netWorkErrorLayout!!.layoutParams.height = dragRange
                recyclerView!!.layoutParams.height = height - dragView!!.height
                progressLayout!!.layoutParams.height = dragRange
            }
        }
    }

package com.change.demox.views.collapsingtoolbarlayout
...
import com.change.demox.views.collapsingtoolbarlayout.component.BaseActivity
import com.change.demox.views.collapsingtoolbarlayout.component.CleanLeakUtils
import com.change.demox.views.collapsingtoolbarlayout.component.StatusBarUtil
 ...
 * desc: CollapsingToolbarLayout实现的个人主页
 */
    ...
    override fun initView() {
        ...
        refreshLayout.setOnMultiPurposeListener(object : SimpleMultiPurposeListener() {
            override fun onHeaderPulling(header: RefreshHeader?, percent: Float, offset: Int, bottomHeight: Int, extendHeight: Int) {
                ...
                toolbar.alpha = 1 - min(percent, 1f)
            }
